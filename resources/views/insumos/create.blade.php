    ...
    <div class="container py-4">
        ...
        <div class="inventario-header">
            ...
            <div class="header-title">
                <h4><i class="fas fa-coffee"></i> Nuevo Insumo</h4>
                <p>Registrar insumo en el almacén</p>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="tipo" class="form-control @error('tipo') is-invalid @enderror" required>
                            ...
                            <option value="piezas"  {{ old('tipo')=='piezas'  ? 'selected' : '' }}>Piezas</option>
                            <option value="gramos"  {{ old('tipo')=='gramos'  ? 'selected' : '' }}>Gramos</option>
                            <option value="litros"  {{ old('tipo')=='litros'  ? 'selected' : '' }}>Litros</option>
                        </select>
